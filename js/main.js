 ...
 // SVG to work with.  The vis <div> is defined in HTML
	...
	*/
	var circleFunc = function(circle) {
		//purely defining attributes
		circle.attr('cx', function(d) {return xScale(d.le_1960)})
		circle.attr('cy', function(d) {return yScale(d.le_2013)})
		circle.attr('title', function(d) {return d.country})
		circle.attr('r',7)
	...
	var draw = function(data) {
		...
		g.selectAll('circle').transition().duration(2000).call(circleFunc)
